...
<!-- generated-from:ef7371e0e20e360edd7491bf720684da84d7821aa9bf02f8f6bc2e0bda7fae46 DO NOT REMOVE, DO UPDATE -->
...
Please review our [Code of Conduct](https://github.com/moov-io/fincen/blob/master/CODE_OF_CONDUCT.md) to ensure you agree with the values of this project.
...
$ git clone git@github.com:moov-io/fincen.git
```
...
First, [Fork our project](https://github.com/moov-io/fincen) somewhere and after that's done add the remote:

```
$ cd $GOPATH/src/github.com/moov-io/fincen # Whereever this project's source code is

$ git remote add $user git@github.com:$user/fincen.git # After
...
Our Build pipeline utilizes [Github Actions](https://github.com/moov-io/fincen/actions) to enforce many tools that you should add to your editor before issuing a pull request.
