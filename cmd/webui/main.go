...
func main() {
	...
	log.Printf("Starting moov-io/fincen webui version %s", fincen.Version)
	...
	if err != nil {
		errs <- fmt.Errorf("problem creating admin server: %v", err)
	}
	adminServer.AddVersionHandler(fincen.Version) // Setup 'GET /version'
	go func() {
